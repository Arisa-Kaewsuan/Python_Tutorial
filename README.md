...
-  &nbsp; PYTHON &nbsp;BASIC &nbsp;:&nbsp;<br/>
   > ควรมีพื้นฐาน Basic Programming ที่รู้ว่าคำสั่งพื้นฐานที่ใช้บ่อยๆ จึงควรจำหรือใช้จนคุ้นเคย มีอะไรบ้าง ? เพื่อให้เอาไปรวมร่าง ประกอบกันจนกลายเป็นโปรแกรมนึงขึ้นมาได้ ด้วยหลักการเขียนแบบ OOP และมาตรวจสอบปรับปรุงให้ดีขึ้น (เร็ว และใช้หน่วยความจำน้อย) ได้โดยใช้ BigO ที่ เป็นความรู้ในวิชา Data Structure & Algorithm เพราะ คำสั่งพื้นฐานที่ใช้บ่อยๆ แบ่งเป็นกลุ่มๆแล้ว ทุกภาษาจะมีเหมือนๆกัน แค่ใช้ syntax ที่แตกต่างกันในการเขียน ทั้งยังบ่งบอกด้วยว่าภาษานั้นๆทำอะไรได้บ้าง เช่น python มีกลุ่มคำสั่ง GUI ให้ใช้ ก็เลยสามารถทำโปรแกรมแบบมี GUI ได้

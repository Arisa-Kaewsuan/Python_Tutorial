...
- เริ่มใช้ SQL 
  ...
  ### &nbsp;&nbsp;&nbsp; 3.2 &nbsp; mongoDB &nbsp;⚡️
                ...
                ควรมีพื้นฐาน รู้ว่า mongoDB คืออะไร , มันเก็บข้อมูลแบบไหน , รู้ศัพท์เกี่ยวกับ mongoDB เพราะมันใช้คำเรียกต่างกันแต่จริงๆ
        ก็คืออันเดียวกันกับใน database อื่นๆ เช่น mysql ช่วยให้เราเข้าใจมากขึ้นเวลาใช้งาน 
